...
public class NunchakuItem extends CustomItem {

    // Standard ID/Description
    public static final String ITEM_ID = YakuzaMod.makeID("NunchakuItem");
    ...
    public NunchakuItem(int upgraded, int durability) {
        super(ITEM_ID, orbString.NAME,
                durability,
                ATTACK_AMOUNT,
                SKILL_AMOUNT,
                THROW_AMOUNT,
                makeOrbPath("nunchaku_item.png"));
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        description = DESCRIPTIONS[0] + attackValue + DESCRIPTIONS[1] + attackValue + DESCRIPTIONS[2] +
                DESCRIPTIONS[3] + skillValue + DESCRIPTIONS[4] +
    ...
    public void performAdditionalAttackEffect(AbstractCard card) {
        AbstractDungeon.actionManager
                .addToBottom(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, attackValue));
    }
