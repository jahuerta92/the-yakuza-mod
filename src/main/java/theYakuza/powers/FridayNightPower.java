...
public class FridayNightPower extends AbstractGrabPower implements CloneablePowerInterface, NonStackablePower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("friday_night_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("friday_night_power32.png"));

    public FridayNightPower(final AbstractCreature owner, final AbstractCreature source, int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new FridayNightPower(owner, source, amount);
    }
}
