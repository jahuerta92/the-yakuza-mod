...
public class RetaliatePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = YakuzaMod.makeID("Retaliate");
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("retaliate_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("retaliate_power32.png"));
