...
public class ColiseumPower extends AbstractMinigamePower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = YakuzaMod.makeID("Coliseum");
    ...
    public AbstractPower makeCopy() {
        return new ColiseumPower(owner, source, amount);
    }
