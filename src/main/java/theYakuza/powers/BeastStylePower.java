...
public class BeastStylePower extends AbstractGrabPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("BeastStyle");
    ...
    public AbstractPower makeCopy() {
        return new BeastStylePower(amount);
    }
}
