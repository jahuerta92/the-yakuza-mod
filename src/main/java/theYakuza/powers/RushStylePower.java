...
public class RushStylePower extends AbstractPower implements CloneablePowerInterface {
    ...
    public void onAfterCardPlayed(AbstractCard usedCard) {
        if (usedCard.type == CardType.ATTACK) {
            ...
            AbstractDungeon.actionManager
                    .addToBottom(new ApplyPowerAction(owner, owner, new DexterityPower(owner, amount)));
            AbstractDungeon.actionManager
                    .addToBottom(new ApplyPowerAction(owner, owner, new LoseDexterityPower(owner, amount)));
        }
    }
    ...
    public AbstractPower makeCopy() {
        return new RushStylePower(amount);
    }
}
