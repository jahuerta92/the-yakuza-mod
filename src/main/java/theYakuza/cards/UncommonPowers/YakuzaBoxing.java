...
public class YakuzaBoxing extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaBoxing.class.getSimpleName());
    public static final String IMG = makeCardPath("Yakuza_Boxing.png");// "public static final String IMG =
