...
import theYakuza.items.DragonKartItem;
...
// it does.
public class YakuzaGrabDragonKart extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = YakuzaMod.makeID(YakuzaGrabDragonKart.class.getSimpleName()); // USE THIS
                                                                                                  // ONE
                                                                                                  // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Grab_Dragon_Kart.png");// "public static final String IMG =
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new GrabAction(new DragonKartItem(0, durability)));
    }
