...
public class YakuzaKomakiParry extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaKomakiParry.class.getSimpleName()); // USE THIS ONE
                                                                                               // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Komaki_Parry.png");// "public static final String IMG =
