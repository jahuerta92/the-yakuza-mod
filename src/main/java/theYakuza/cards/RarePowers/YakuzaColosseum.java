...
import theYakuza.powers.ColosseumPower;

import static theYakuza.DefaultMod.makeCardPath;

public class YakuzaColosseum extends AbstractDynamicCard {

    public static final String ID = DefaultMod.makeID(YakuzaColosseum.class.getSimpleName());
    ...
    public YakuzaColosseum() { // public ${NAME}() - This one and the one right under the imports are the
                               // most
