...
public class YakuzaBaseball extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(YakuzaBaseball.class.getSimpleName()); // USE THIS ONE FOR THE
    // TEMPLATE;
    ...
    private static final int DAMAGE = 7; // 7// DAMAGE = ${DAMAGE}
