...
public class YakuzaStrike extends CustomCard {
    ...
    // Setting the image as as easy as can possibly be now. You just need to provide
    // the image name
    ...
    // Go check out DefaultAttackWithVariable and
    // theDefault.variable.DefaultCustomVariable
    // that's how you get your own custom variable that you can use for anything you
    // like.
    // Feel free to explore other mods to see what variables they personally have
    // and create your own ones.

    // /STAT DECLARATION/

    // IMPORTANT NOTE: If you add parameters to your constructor, you'll crash the
    // auto-add cards with a
    // `NoSuchMethodException` because it except a constructor with no params.
    // (If you don't know what a constructor or params are or what not pls google,
    // java questions = java study)
    // You have two option:
    // 1. Create a new constructor with empty parameters call your custom one with
    // default params in it
    // 2. Mark the card with @AutoAdd.NotSeen
    // (https://github.com/daviscook477/BaseMod/wiki/AutoAdd) to prevent it from
    ...
    public YakuzaStrike() {
        ...
        this.tags.add(CardTags.STARTER_STRIKE); // Tag your strike, defend and form (Wraith form, Demon form, Echo form,
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom( // The action managed queues all the actions a card should do.
                ...
                new DamageAction(m, new DamageInfo(p, damage, damageTypeForTurn),
                        ...
                        // Chances are you'd instead look at "hey my card is similar to this basegame
                        // card"
                        // Let's find out what action *it* uses.
                        // I.e. i want energy gain or card draw, lemme check out Adrenaline
                        // P.s. if you want to damage ALL enemies OUTSIDE of a card, check out the
                        // custom orb.
                        AbstractGameAction.AttackEffect.SLASH_HORIZONTAL)); // The animation the damage action uses to
                                                                            // hit.
    }
