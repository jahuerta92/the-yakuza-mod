...
public class YakuzaEssenceOfSlapping extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaEssenceOfSlapping.class.getSimpleName()); // USE THIS
                                                                                                     // ONE
                                                                                                     // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Essence_Of_Slapping.png");// "public static final String IMG =
    ...
    private static final int DAMAGE = 8; // 7// DAMAGE = ${DAMAGE}
