...
public class YakuzaEssenceOfComboRush extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(YakuzaEssenceOfComboRush.class.getSimpleName()); // USE THIS ONE
                                                                                                       // FOR THE
    // TEMPLATE;
    ...
    private static final int DAMAGE = 11; // 7// DAMAGE = ${DAMAGE}
