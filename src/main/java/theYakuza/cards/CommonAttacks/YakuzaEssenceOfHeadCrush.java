...
public class YakuzaEssenceOfHeadCrush extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaEssenceOfHeadCrush.class.getSimpleName()); // USE THIS
                                                                                                      // ONE
                                                                                                      // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Essence_Of_Head_Crush.png");// "public static final String IMG
                                                                                      // =
