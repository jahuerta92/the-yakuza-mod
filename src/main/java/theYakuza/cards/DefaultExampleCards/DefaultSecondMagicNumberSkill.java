...
public class DefaultSecondMagicNumberSkill extends AbstractDynamicCard {
     ...
     *
     * Using the second magic number isn't very confusing, you just declare and use
     * it the absolutely the same way you would your
    ...
    public static final String ID = YakuzaMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(m, p, new PoisonPower(m, p, this.defaultSecondMagicNumber),
