...
public class YakuzaEssenceOfImprovisation extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaEssenceOfImprovisation.class.getSimpleName()); // USE THIS
                                                                                                          // ONE
                                                                                                          // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Essence_Of_Improvisation.png");// "public static final String
                                                                                         // IMG =
