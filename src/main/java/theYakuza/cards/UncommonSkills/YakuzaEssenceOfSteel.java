...
public class YakuzaEssenceOfSteel extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaEssenceOfSteel.class.getSimpleName()); // USE THIS
                                                                                                  // ONE
                                                                                                  // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Essence_Of_Steel.png");// "public static final String IMG =
