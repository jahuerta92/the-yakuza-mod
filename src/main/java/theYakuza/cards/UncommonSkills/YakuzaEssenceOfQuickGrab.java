...
// it does.
public class YakuzaEssenceOfQuickGrab extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(YakuzaEssenceOfQuickGrab.class.getSimpleName()); // USE THIS
                                                                                                       // ONE
                                                                                                       // FOR THE
    // TEMPLATE;
    ...
    // /STAT DECLARATION/
    public YakuzaEssenceOfQuickGrab() { // public ${NAME}() - This one and the one right under the imports are the
                                        // most
