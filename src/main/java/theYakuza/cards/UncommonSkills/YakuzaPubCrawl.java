...
public class YakuzaPubCrawl extends AbstractDynamicCard {
    ...
    public static final String ID = YakuzaMod.makeID(YakuzaPubCrawl.class.getSimpleName()); // USE THIS
                                                                                            // ONE
                                                                                            // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Pub_Crawl.png");// "public static final String IMG =
