...
// it does.
public class YakuzaPocketCircuit extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = YakuzaMod.makeID(YakuzaPocketCircuit.class.getSimpleName()); // USE THIS
    // ONE
    // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Pocket_Circuit.png");// "public static final String
    // IMG =
    ...
    // /STAT DECLARATION/
    public YakuzaPocketCircuit() { // public ${NAME}() - This one and the one right under the imports are the
        // most
