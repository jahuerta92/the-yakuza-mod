...
public class YakuzaPoker extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = YakuzaMod.makeID(YakuzaPoker.class.getSimpleName());
    public static final String IMG = makeCardPath("Yakuza_Poker.png");
