...
public class YakuzaGrabPan extends AbstractDynamicCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new GrabAction(new PanItem(this.itemUpgrades, durability)));
    }
