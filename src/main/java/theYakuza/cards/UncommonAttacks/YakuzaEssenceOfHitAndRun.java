...
// it does.
public class YakuzaEssenceOfHitAndRun extends AbstractDynamicCard {
    // TEXT DECLARATION

    public static final String ID = YakuzaMod.makeID(YakuzaEssenceOfHitAndRun.class.getSimpleName()); // USE THIS ONE
                                                                                                      // FOR THE
    // TEMPLATE;
    public static final String IMG = makeCardPath("Yakuza_Essence_Of_Hit_And_Run.png");// "public static final String
                                                                                       // IMG =
    ...
    // /STAT DECLARATION/
    public YakuzaEssenceOfHitAndRun() { // public ${NAME}() - This one and the one right under the imports are the most
