...
import theYakuza.potions.PlaceholderPotion;
import theYakuza.relics.BottledPlaceholderRelic;
...
public class DefaultMod implements
    ...
    private static final String AUTHOR = "You"; // And pretty soon - You!
    ...
    public void receiveEditCharacters() {
        ...
        BaseMod.addCharacter(new TheDefault("The Yakuza", TheDefault.Enums.THE_DEFAULT),
